...
comm_dict = {'^GSPC': 'SP_500', '^DJI': 'DJI30', '^IXIC': 'NASDAQ', 
             ...
             '^N100': 'Euronext 100 Index', '^N225': 'Nikkei 225','^FCHI':'CAC 40','^AXJO':'S&P/ASX 200','EURUSD=X': 'EUR_USD', 'EURCHF=X': 'EUR_CHF', 
             'CNY=X': 'USD/CNY', 'GBPUSD=X': 'USD_GBP', 'JPY=X': 'USD_JPY', 'EURPLN=X': 'EUR/PLN', 'PLN=X': 'PLN/USD','GBPPLN=X':'PLN/GBP',
             'RUB=X': 'USD/RUB','EURRUB=X':'EUR/RUB','MXN=X':'USD/MXN', 'EURJPY=X':'EUR/JPY','EURSEK=X':'EUR/SEK','DX-Y.NYB': 'US Dollar Index', 
             ...
             'SI=F': 'Silver', 'NG=F': 'Natural Gas', 'ZR=F': 'Rice Futures', 'ZS=F': 'Soy Futures', 'BTC-USD': 'Bitcoin USD','ETH-USD': 'Ethereum USD'} #,'CNYRUB=X':'CNY/RUB'
